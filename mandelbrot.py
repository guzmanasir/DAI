...
# Renderiza un fractal de Mandelbrot de (x1, y1) a (x2, y2) de ancho
# pixeles, iteraciones máximas y lo guarda en el fichero especificado en
# nombreFicheroPNG (debe tener extesión .png) y permitiendo especificar
# una paleta de colores: paleta es una lista de 3-tuplas con los valores
# RGB de cada color de la paleta
